  ...
  return (
    <div className="relative isolate bg-white px-6 py-24 sm:py-32 lg:px-8">
      ...
      <div className="mx-auto max-w-4xl text-center">
        <p className="mt-2 text-balance text-5xl font-semibold tracking-tight text-gray-900 md:text-5xl">
      ...
      <div className="mx-auto mt-16 grid max-w-lg grid-cols-1 items-center gap-y-6 md:gap-x-8 sm:mt-20 sm:gap-y-0 lg:max-w-4xl lg:grid-cols-3">
        {subscriptions.map((sub) => (
          <div
            className="rounded-3xl rounded-t-3xl bg-white/60 ring-1 ring-[#350203] sm:mx-8 sm:p-10 lg:mx-0 flex flex-col items-center justify-center"
            key={sub.id}
          >
            ...
            <button
              ...
              className="block rounded-2xl px-3.5 py-2.5 text-center text-sm font-semibold text-[#350203] ring-1 ring-inset ring-indigo-200 hover:ring-[#350203] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#350203] mt-4"
