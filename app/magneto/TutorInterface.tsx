...
const TutorInterface: FC = () => {
  ...
  return (
    <section className="font-Montserrat tracking-wide fixed inset-0 mt-16 flex items-center justify-center z-10">
      <div className="bg-[#221d1a] w-full max-w-full h-[80vh] md:h-[90vh] flex">
        <AppSidebar />
        <SidebarInset>
          {/* Header Section */}
                ...
                >
                  ...
                  <div
                    className={`max-w-2xl px-4 py-2 ${
                      msg.sender === "user"
                        ? "self-end bg-white rounded-bl-2xl rounded-tr-2xl text-[#350203]"
                        : "self-start rounded-2xl p-2 text-white text-base font-normal"
                    }`}
                  >
                    <Markdown
